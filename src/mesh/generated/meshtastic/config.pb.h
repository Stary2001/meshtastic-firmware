...
typedef enum _meshtastic_Config_LoRaConfig_RegionCode {
    ...
    /* EU 868 - Narrow with guard bands */
    meshtastic_Config_LoRaConfig_RegionCode_EU_NARROW = 27
...
typedef enum _meshtastic_Config_LoRaConfig_ModemPreset {
 ...
 It is not legal to use in all regions due to this wider bandwidth. */
    ...
    /* Narrow bandwidth, approximately equivalent to LongFast */
    meshtastic_Config_LoRaConfig_ModemPreset_NARROW_SLOW = 9,
    /* Narrow bandwidth, approximately equivalent to MediumSlow */
    meshtastic_Config_LoRaConfig_ModemPreset_NARROW_MODERATE = 10,
    /* Narrow bandwidth, approximately equivalent to MediumFast */
    meshtastic_Config_LoRaConfig_ModemPreset_NARROW_FAST = 11,
    /* Narrow bandwidth, approximately equivalent to ShortSlow */
    meshtastic_Config_LoRaConfig_ModemPreset_NARROW_TURBO = 12
...
#define _meshtastic_Config_LoRaConfig_RegionCode_MAX meshtastic_Config_LoRaConfig_RegionCode_EU_NARROW
#define _meshtastic_Config_LoRaConfig_RegionCode_ARRAYSIZE ((meshtastic_Config_LoRaConfig_RegionCode)(meshtastic_Config_LoRaConfig_RegionCode_EU_NARROW+1))

#define _meshtastic_Config_LoRaConfig_ModemPreset_MIN meshtastic_Config_LoRaConfig_ModemPreset_LONG_FAST
#define _meshtastic_Config_LoRaConfig_ModemPreset_MAX meshtastic_Config_LoRaConfig_ModemPreset_NARROW_TURBO
#define _meshtastic_Config_LoRaConfig_ModemPreset_ARRAYSIZE ((meshtastic_Config_LoRaConfig_ModemPreset)(meshtastic_Config_LoRaConfig_ModemPreset_NARROW_TURBO+1))
